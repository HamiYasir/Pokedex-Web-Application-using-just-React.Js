...
// This is basically used to balance out indexing as indexing starts with index 0 while the first pokemon starts with index 1
export function getPokedexNumber(index) {
    return index + 1
}

// This function is for formatting of the indexing so that they represent pokemon ids. Pokemon ids are 3 digit numbers.
